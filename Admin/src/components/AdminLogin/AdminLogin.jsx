...
const AdminLogin = () => {
  ...
  useEffect(() => {
    const checkAdminAndToken = async () => {
      try {
        const adminRes = await axios.get("https://certificate-gen-c66k.onrender.com/api/v1/Admin/Check");
        setIsAdminExists(adminRes.data.exist);

        // Call the CheckToken endpoint to verify token existence
        const tokenRes = await axios.get("https://certificate-gen-c66k.onrender.com/api/v1/Admin/CheckToken", {
    ...
    try {
      ...
      if (isAdminExists) {
        ...
        res = await axios.post(
          "https://certificate-gen-c66k.onrender.com/api/v1/Admin/Login",
          formData,
          { withCredentials: true }
        );
        console.log(res);
        ...
        res = await axios.post(
          "https://certificate-gen-c66k.onrender.com/api/v1/Admin/Register",
          formData,
          { withCredentials: true }
        );
      }
